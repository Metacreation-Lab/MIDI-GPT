...
the refactored midigpt server and compares:
...
def _make_orig_server(params_override: dict | None = None):
    import midigpt_legacy.osc_server as orig_mod
...
def _make_ref_server(params_override: dict | None = None):
    from midigpt.server.osc_server import MidiGPTServer as RefServer
